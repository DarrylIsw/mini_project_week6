...
class ContinentAdapter(
    ...
    private val continents: List<String>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ContinentViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.item_continent, parent, false)
    ...
    override fun onBindViewHolder(holder: ContinentViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener { onClick(continent) }
    }
    ...
    inner class ContinentViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val nameTv: TextView = itemView.findViewById(R.id.tvContinentName)
        private val imageIv: ImageView = itemView.findViewById(R.id.ivContinent)

        fun bind(continent: String) {
            nameTv.text = continent

            // Set icon for each continent
